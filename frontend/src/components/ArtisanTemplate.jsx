 ...
 * Theme: Organic & Earthy (Instrument Serif + Manrope, deep green + terra accent).
...
export default function ArtisanTemplate({ site, onSubmitLead, editable = false, onEdit }) {
  ...
  return (
    <div className="artisan-site min-h-screen" data-testid="artisan-template">
      ...
      {/* VALUE PROPS */}
      <section className="bg-[#F3F1EC] py-16 md:py-24">
      ...
      {/* ABOUT */}
      <section id="about" className="py-20 md:py-28 bg-[#1F3D2D] text-[#FDFBF7]">
