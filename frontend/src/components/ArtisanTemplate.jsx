...
export default function ArtisanTemplate({ site, onSubmitLead, editable = false, onEdit }) {
  ...
  const HERO_BY_JOB = {
    plomberie: 'https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?q=80&w=1600',
    electricite: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?q=80&w=1600',
    maconnerie: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=1600',
    peinture: 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?q=80&w=1600',
    menuiserie: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?q=80&w=1600',
    chauffage: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?q=80&w=1600',
    couverture: 'https://images.unsplash.com/photo-1516156008625-3a9d6067fab5?q=80&w=1600',
    carrelage: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=1600',
    paysagiste: 'https://images.unsplash.com/photo-1557429287-b2e26467fc2b?q=80&w=1600',
    serrurerie: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=1600',
    platrerie: 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?q=80&w=1600',
    renovation: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1600',
    climatisation: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=1600',
    jardinage: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?q=80&w=1600',
    nettoyage: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=1600',
  };
          ...
          {(c.services || []).map((s, i) => (
            <article key={i} className="bg-[#F3F1EC] rounded-lg overflow-hidden group hover:shadow-md transition-shadow" data-testid={`service-${i}`}>
              <div className="aspect-[16/10] overflow-hidden bg-[#E5E1D8]">
                {(() => {
                  const serviceData = SERVICES_BY_JOB[jobKey]?.find(sv => sv.title.toLowerCase() === s.name.toLowerCase());
                  const imgSrc = serviceData?.image || "https://images.pexels.com/photos/4756489/pexels-photo-4756489.jpeg";
                  return <img src={imgSrc} alt={s.name} loading="lazy" decoding="async" width="800" height="500" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />;
                })()}
              </div>
              <div className="p-7">
