...
export default function Admin() {
  ...
  if (loading) {
    return <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center"><Loader2 className="w-6 h-6 animate-spin text-[#F95A2C]" /></div>;
  }
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]" data-testid="admin-page">
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-8 py-12">
        <div className="mb-8">
          <div className="font-mono-grotesk text-[10px] uppercase tracking-[0.2em] text-[#71717A] mb-3">// console</div>
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="h-12 bg-white border border-black/10 rounded-none p-0 gap-0">
            <TabsTrigger value="overview" className="rounded-none data-[state=active]:bg-[#09090B] data-[state=active]:text-white px-6 h-12" data-testid="tab-overview">Vue d'ensemble</TabsTrigger>
